...
[_DEFAULT] = LAYOUT( \
  ...
  KC_LCTL,         KC_A,    LT(2, KC_S),    MT(MOD_LGUI, KC_D), MT(MOD_LALT, KC_F), MT(MOD_LCTL, KC_G),        KC_H,          KC_J,    KC_K,           KC_L,    KC_SCLN, KC_ENT, \
...
[_SPACE_FN] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______,         KC_NO,   KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, \
