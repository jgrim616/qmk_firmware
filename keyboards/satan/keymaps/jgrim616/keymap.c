...
[_MFL] = KEYMAP_ANSI(
  ...
  TO(_MBL2),TO(_WBL2),_______,              _______,                       TO(_AML),_______,TO(_WBL),TO(_MBL) ),
  #endif
...
[_WFL] = KEYMAP_ANSI(
  ...
  _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,        _______, \
  _______,RGB_TOG,RGB_MOD,RGB_HUI,RGB_HUD,RGB_SAI,RGB_SAD,RGB_VAI,RGB_VAD,_______,_______,_______, \
  TO(_MBL2),TO(_WBL2),_______,               _______,                       _______,_______,_______, _______),
  #else
  KC_GRV, KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12, KC_DEL,  \
   ...
   */
[_AML] = KEYMAP_ANSI(
  _______,TO(_WBL),TO(_MBL),_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,  \
