...
[_MFL] = KEYMAP_ANSI(
  ...
  _______,_______,KC_UP,  _______,_______,_______,KC_CALC,_______,KC_INS, _______,KC_PSCR,KC_SLCK,KC_PAUS,KC_PWR, \
...
[_WFL] = KEYMAP_ANSI(
  ...
  #else
  KC_GRV, KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12, KC_DEL,  \
  _______,_______,KC_UP,  _______,_______,_______,KC_CALC,_______,KC_INS, _______,KC_PSCR,KC_SLCK,KC_PAUS,KC_SLEP, \
  _______,KC_LEFT,KC_DOWN,KC_RGHT,_______,_______,_______,_______,_______,_______,KC_HOME,KC_PGUP,_______, \
  _______,_______,KC_MENU,BL_DEC, BL_TOGG,BL_INC, KC_VOLD,KC_VOLU,KC_MUTE,KC_END, KC_PGDN,_______, \
  _______,RESET,  _______,                _______,                        _______,_______,TO(_WBL),TO(_MBL) ),
  #endif
